    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('INT', 'Intern'), ('RES', 'Resident'), ('ATT', 'Attending')], max_length=3)),
                ('speciality', models.CharField(choices=[('GEN', 'General'), ('CAR', 'Cardiothoracic'), ('NEU', 'Neurosurgery'), ('PED', 'Pediatric')], max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
